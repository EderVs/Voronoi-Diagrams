...
class TestWeightedPointBoundaryIsPointInAllRegion:
    """Test _is_point_in_both_boundaries method in WeightedPointBoundary."""
    ...
    def test_with_concave_to_y_boundary(self):
        ...
        assert boundary_plus._is_point_in_both_boundaries(
            point
        ) == boundary_minus._is_point_in_both_boundaries(point)
        assert boundary_plus._is_point_in_both_boundaries(point)
        # Point in Boundary-
        ...
        assert not boundary_plus._is_point_in_both_boundaries(point)
    ...
    def test_with_normal_boundary(self):
        ...
        # Points in boundary
        # Point in both boundaries
        point = Point(Decimal("40"), Decimal("37"))
        assert boundary_plus._is_point_in_both_boundaries(
            point
        ) == boundary_minus._is_point_in_both_boundaries(point)
        assert boundary_plus._is_point_in_both_boundaries(point)
