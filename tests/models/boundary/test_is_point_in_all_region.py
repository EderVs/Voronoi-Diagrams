...
class TestWeightedPointBoundaryIsPointInAllRegion:
    """Test _is_point_in_all_region method in WeightedPointBoundary."""
    ...
    def test_with_concave_to_y_boundary(self):
        ...
        assert boundary_plus._is_point_in_all_region(
            point
        ) == boundary_minus._is_point_in_all_region(point)
        assert boundary_plus._is_point_in_all_region(point)
        # Point in Boundary-
        ...
        assert not boundary_plus._is_point_in_all_region(point)
